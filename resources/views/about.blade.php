...
@section('content')
    ...
    <section class="text-center text-white d-flex align-items-center justify-content-center flex-column"
        style="background: linear-gradient(rgba(50, 90, 60, 0.85), rgba(50, 90, 60, 0.85)),
                url('{{ asset('images/plant-hero.png') }}') center/cover no-repeat; 
                height: 50vh;">
        <h1 class="mb-3" style="font-family: 'Pacifico'; font-size: 3.5rem;">Tentang Carnivorous Plants</h1>
        <p class="lead" style="font-size: 1.2rem; max-width: 600px; color: #1E293B;">
        Temukan dan koleksi tanaman terbaik,<br>semuanya di satu tempat!
        </p>
    </section>

    {{-- Our Story Section --}}
    <section class="py-5" style="background-color: #416D43;">
        <div class="container d-flex justify-content-center">
            <div class="d-flex justify-content-center align-items-center gap-5 flex-wrap text-center text-lg-start">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <h2 class="mb-4" style="font-family: 'Potta One'; color: #af893dff;">Cerita Kami</h2>
                    <p class="mb-3" style="color: #1E293B; line-height: 1.8;">
                        Carnivorous Plants lahir dari kecintaan terhadap alam dan tanaman hias. Kami ingin membuat platform 
